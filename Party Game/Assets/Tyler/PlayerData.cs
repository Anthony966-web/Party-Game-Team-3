...
public class PlayerData : ScriptableObject
{
    ...
    public float fastSlideSpeed;
    public float fastSlideAccel;
	...
	[Header("Slide Attack")]
    public float slideAttackSpeed;
    public float slideAttackAccel;
    public float slideAttackTime;
    public float slideEndTime;
    public Vector2 slideEndSpeed;
