...
public class PlayerMovement : MonoBehaviour
{
	...
	public Transform GParticleScale;
    #endregion
	...
	public bool StoppedWalking { get; private set; }
    ...
    public float TimeTillAirControl { get; private set; }
    ...
    private void Update()
	{
        ...
        var groundEmission = GroundParticles.emission;
        ...
        if (Mathf.Abs(RB.linearVelocityX) > 0.01f)
        {
            ...
            groundEmission.rateOverTime = 21;
        }
        else
        {
            anim.SetBool("isRunning", false);
            groundEmission.rateOverTime = 0;
        }
        ...
        if (!isGrounded && _isJumpFalling && _moveInput.y < 0)
        {
            IsFastFalling = true;
        }
    ...
    private void Run(float lerpAmount)
	{
		...
		if (IsWalking)
		{
			StartCoroutine(nameof(RUNCHECK));
		}
	...
	private void Slide()
	{
		...
		//if (isOnLeftWall && IsFacingRight || isOnRightWall && !IsFacingRight)
		//{
		//	Turn();
		//}
    }
	...
	public IEnumerator RUNCHECK()
	{
		...
		if (LastMoveTime < 0 && LastMoveTime > -0.2f)
		{
            CanRun = true;
			return null;
		}
	...
	public bool CanTurn()
	{
		if (LastOnGroundTime == Data.coyoteTime || LastOnWallTime == Data.wallJumpCoyoteTime)
		{
			return true;
		}
		else
